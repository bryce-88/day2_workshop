...
public final class App {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < bankAccount.length; i++) {
            ...
            double initBalance = min + randomNum.nextDouble();

            bankAccount[i] = new FixedDepositAccount(uuid, initBalance);
        ...
        bankAccount[1].withdraw(3000);
        bankAccount[2].withdraw(4000);
